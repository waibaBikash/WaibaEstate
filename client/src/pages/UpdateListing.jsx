...
export default function CreateListing() {
  ...
  const [uploading, setUploadinig] = useState(false);
      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
              ...
              <div className='flex gap-6 flex-wrap'>
                  ...
                  <div className='flex flex-wrap gap-6'>
                     ...
                     <div className='flex items-center gap-2'>
                        ...
                        <div className='flex items-center gap-2'>
                        <input 
                        type='number' id='regularPrice' min='100' max='10000000' required className='p-3 border border-gray-300 rounded-lg' onChange={handleChange}
                     ...
                     <div className='flex items-center gap-2'>
                     <input 
                     type="number" id="discountPrice" min='0' max='1000000' required className='p-3 border border-gray-300 rounded-lg' onChange={handleChange}
           ...
           <div className='flex flex-col flex-1 gap-4'>
             <p className='font-semibold'>
              Images:
             <span 
             className='font-normal text-gray-600 ml-2'> The fist image will be the cover (max 6)
             </span>
             </p>
                <div className='flex gap-4'>
                   <input
                    onChange={(e) => setFiles(e.target.files)} className='p-3 border border-gray-300 rounded w-full' type='file'  id='images' accept='image/*' multiple
                     />
                   <button 
                    type='button'
                    disabled={uploading}
